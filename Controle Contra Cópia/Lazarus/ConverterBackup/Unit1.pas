...
uses
  ...
  Controls, Forms, Dialogs, ExtCtrls, StdCtrls, Registry, IniFiles, IpHlpApi,
  IpTypes, JvComponentBase, JvComputerInfoEx;
...
type
  TForm1 = class(TForm)
    ...
    function SysVersion(var Ver: _OSVERSIONINFOW): boolean;
...
function TForm1.SysVersion(var Ver: _OSVERSIONINFOW): boolean;
begin
  Ver.dwOSVersionInfoSize := SizeOf(Ver);
  Result := GetVersionEx(Ver);
end;

function TForm1.SysVersionStr: string;
var
  Ver: _OSVERSIONINFOW;
begin
