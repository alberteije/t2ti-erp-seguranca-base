...
uses
  ...
  ComCtrls, DB, BufDataset, Grids, DBGrids, FMTBcd,
  DateUtils, ZConnection, ZDataset;
...
begin
  ...
  Memo1.Lines.Add('Chave Desbloqueio = ' + MD5Print(MD5String(ZTable1.FieldByName('f').AsString + 'uma_chave')));
  Memo1.Lines.Add('=====================================================');
end;

procedure TForm1.Button7Click(Sender: TObject);
begin
  if EditChaveDesbloqueio.Text = MD5Print(MD5String(ZTable1.FieldByName('f').AsString + 'uma_chave')) then
  begin
    ZTable1.Edit;
...
begin
  ...
  Memo2.Lines.Add('Chave Desbloqueio = ' + MD5Print(MD5String(BufDataset2.FieldByName('f').AsString + 'uma_chave')));
  Memo2.Lines.Add('=====================================================');
end;

procedure TForm1.Button8Click(Sender: TObject);
begin
  if EditChaveDesbloqueioArquivo.Text = MD5Print(MD5String(BufDataset2.FieldByName('f').AsString + 'uma_chave')) then
  begin
    BufDataset2.Edit;
